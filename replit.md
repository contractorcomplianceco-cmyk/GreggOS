...
- `pages/*.tsx` — gregg-today (incl. Command Center tiles row), clients, client-detail, processor, weekly-review, oversight, admin, audit-risk, the Phase-2 pages **expansion.tsx** and **relationships.tsx**, **communications.tsx** (Communication Draft Builder), and the Command Center modules **travel-planner.tsx**, **expenses.tsx**, **training.tsx**, **feedback.tsx**, **prompt-library.tsx** (static), **motivation.tsx** (static).
